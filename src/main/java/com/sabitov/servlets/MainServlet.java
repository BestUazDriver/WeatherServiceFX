...
public class MainServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("/html/weather_info.html").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        URL getUrl = new URL("https://api.openweathermap.org/data/2.5/weather?q=" + jsonMap.get("city") + "&appid=" + keyApi);
        ...
        Map<String, String> json1 = JsonWeatherParserService.parseJson(content.toString());
